...
vector<float> *Cubes::generatorCubeData(int requestedCubeFactor, bool toggleVbos, bool toggleStride) {
...
vector<float> *Cubes::generateCubeData(float *point1,
                                       float *point2,
                                       float *point3,
                                       float *point4,
                                       float *point5,
    ...
    auto *cubeData = new vector<float>();
...
void Cubes::getBuffers(vector<float> *cubePositions, vector<float> *cubeNormals, vector<float> *cubeTextureCoordinates, int generatedCubeFactor) {
